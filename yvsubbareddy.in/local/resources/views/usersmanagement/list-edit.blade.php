...
<div class="content">
	@if(Session::has('success'))
	    		...
	    		<h4 class="abt-title mt-4">Update @if($user->user_type==1)MLA @else MP @endif</h4>
	    		<div class="row">
	                   ...
	                   <div class="form-group row">
	    				 ...
	    				 <div class="form-group row">
	    					...
	    					<div class="col-md-9">
	    						...
	    						{{ Form::text('mobile',$user->mobile,array('class' => 'form-control','placeholder'=>'Enter Mobile','required')) }}
	    				...
	    				<div class="form-group row">
	                   	...
	                   	<div class="form-group row mt-2">
	                        ...
	                        <div class="form-group row mt-2">
	                            ...
	                            <div class="col-md-9">
	                                {{Form::select('user_type', array('1' => 'MLA', '2' => 'MP','3' => 'Others') ,$user->user_type ,array('class' => 'form-control','required'))}}
...
<div class="form-group row mt-2">
	                            ...
	                            <div class="col-md-9">
	                           {{Form::select('constituency', $constiuencies,$user->constituency,array('class' => 'form-control','required'))}}   
	    					...
	    					<div class="col-md-9">
	    						...
	    						{{ Form::textarea('address',$user->address,array('class' => 'form-control','placeholder'=>'Enter Address','required')) }}
